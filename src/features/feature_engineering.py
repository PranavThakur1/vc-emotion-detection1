...
def apply_count_vectorizer(train_data: pd.DataFrame, test_data: pd.DataFrame, max_features: int) -> tuple:
...
def main():
    try:
        ...
        train_df, test_df = apply_count_vectorizer(train_data, test_data, max_features)
